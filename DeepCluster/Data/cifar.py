...
from Data.mypath import MyPath
...
class CIFAR10(Dataset):
    ...
    def __init__(self, root=MyPath.db_root_dir('cifar-10'), train=True, transform=None, 
        ...
        for i, image in enumerate(self.data):
            self.imgs.append(image, self.targets[i]) # check stopped here. i need to create self.imgs and change the logic to use (images, labels), instead of (image_path, labels)
    ...
    def _load_meta(self, class_indices):
        ...
        #     self.class_to_idx = {_class: i for i, _class in enumerate(self.classes)}
            # print("here", self.classes, self.class_to_idx)
