...
# this code creates a dataset of cropped cotton fiber images.

def extract_names_and_labels(filepath):
    filename_array = []
    label_array = []
    with open(filepath, 'r') as file:
        for line in file:
            line = line.strip()  # Remove leading/trailing whitespaces
            filename, label = line.split(':')  # Split the line at the ':' character
            filename = filename.strip()  # Remove leading/trailing whitespaces from the filename
            label = int(label.strip())  # Remove leading/trailing whitespaces and convert the label to an integer
            filename_array.append(filename)
            label_array.append(label)

# Print the extracted filenames and labels
images_names_test, labels_test = extract_names_and_labels(r"C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton\train_padded_labels.txt")
print("Filenames:", images_names_test)
...
input_train = image_process( r"C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotto", im_size, images_names_train)


if save:  # set correct path before saving
    np.savetxt(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', labels_train, delimiter=',', fmt='%s')
    np.savetxt(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', labels_test, delimiter=',', fmt='%s')
    np.savetxt(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', images_names_train, delimiter=',', fmt='%s')
    np.savetxt(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', images_names_test, delimiter=',', fmt='%s')
    np.save(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', input_train)
    np.save(r'C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\Datasets\cotton/', input_test)
