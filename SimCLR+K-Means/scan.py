...
from utils.utils import save_features
...
def main():
    ...
    save_path = os.path.join(r"C:\Users\AVLguest\work\Unsupervised\Unsupervised-Classification-master\results", p["train_db_name"], "scan", "features")
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    print(save_path, features.shape, predictions[0]["targets"].shape)

    save_features(features.numpy(), predictions[0]["targets"].numpy(),save_path)
